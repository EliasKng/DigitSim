...
public class Element_NOT extends Element{
    ...
    public Element_NOT(double pX, double pY, int pInputs, NodeGestures dNodeGestures){//Baustein zeichnen
        ...
        lbl = Draw.drawLabel((pX + 20), (pY - 7), "1", Color.BLACK, false, 75);                            //Das Ausrufezeichen Brauchwn wir nicht, da wir ja einen Kreis hinter das Bauteil setzten (damit es wie ein NOT aussieht)
